...
df_slope %>% 
  ...
  labs(caption = "Visualization by Cyrus Wakibia | Data: United Nations Population Division. World Urbanization Prospects: 2018 Revision. | #30DayChartChallenge 2021 Day 5: Slope             ") +
  theme_void() +
...
ggsave('urban-pop-slope.png', width = 10, height = 13.5, 
       units = 'in', bg = 'white')
